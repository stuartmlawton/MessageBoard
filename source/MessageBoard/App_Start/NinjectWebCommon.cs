    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                GlobalConfiguration.Configuration.DependencyResolver = new NinjectResolver(kernel);//tells webapi to resolve dependencies using ninject
                return kernel;
            }
            catch
            {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            //kernel.Bind<IMessageBoardRepository>().To<MockMessageBoardRepository>().InRequestScope();
